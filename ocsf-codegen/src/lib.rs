...
pub fn get_timestamp_matcher() -> regex::Regex {
    regex::Regex::new(r#"^(// This file was automatically generated by ocsf-codegen at .*)"#).unwrap()
}
...
impl CustomScopeThings for Scope {
    ...
    fn add_generation_timestamp_comment(&mut self) {
        ...
        self.writeln(&format!(
            "// This file was automatically generated by ocsf-codegen at {} branch: \"{}\" link: <https://github.com/yaleman/ocsf-rs/commit/{}>",
