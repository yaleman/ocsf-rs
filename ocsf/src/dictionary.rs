...
// This file was automatically generated by ocsf-codegen at 2023-08-11T23:04:14+00:00 branch: "fixing-build-updating-schema" link: <https://github.com/yaleman/ocsf-rs/commit/c9ee180815729dcae5c937f32da30495d8aecf1a> OCSF Schema version: 1.1.0-dev
...
/// Analytic - The analytic technique used to create the finding or detection
...
/// Patch Bulletin - The vendor bulletin identfier.
...
/// Control - The CIS critical security control.
...
/// The product CPE identifier - The Common Platform Enumeration (CPE) name as described by (<a target='_blank' href='https://nvd.nist.gov/products/cpe'>NIST</a>).

pub const CPE: DictAttribute = DictAttribute {
...
/// Data Sources - The data sources for the finding.
...
pub const EMAIL_ADDRESSES: DictAttribute = DictAttribute {
...
/// Firewall Rule - The firewall rules that triggered the events.
...
/// Hire Date - The datetime when the user was/will be hired

pub const HIRE_DATETIME: DictAttribute = DictAttribute {
    caption: "Hire Date",
    default: None,
    ...
    is_array: None,
    sibling: None,
    attr_type: TypeNames::NotSupported { name: "datetime_t" },
};
...
/// Kill Chain - The <a target='_blank' href='https://www.lockheedmartin.com/en-us/capabilities/cyber/cyber-kill-chain.html'>Cyber Kill Chain®</a>.
...
pub const KILL_CHAIN: DictAttribute = DictAttribute {
    ...
    sibling: None,
    attr_type: TypeNames::NotSupported{ name: "kill_chain" },
};
...
/// Last Login - The last time when the user logged in. This is usually populated by `user_inventory` events where a collection method provides this account information. It may not be populated in other event types and doesn't need populated in those cases.
...
/// Leave Date - The datetime when the user left/will be leaving the organization

pub const LEAVE_DATETIME: DictAttribute = DictAttribute {
    caption: "Leave Date",
    default: None,
...
/// Software Packages - The Software Package object describes details about a software package. Defined by D3FEND <a target='_blank' href='https://d3fend.mitre.org/dao/artifact/d3f:SoftwarePackage/'>d3f:SoftwarePackage</a>.
...
/// Package URL - A purl is a URL string used to identify and locate a software package in a mostly universal and uniform way across programing languages, package managers, packaging conventions, tools, APIs and databases.
...
/// Security Standards - A list of security standards associated to a compliance finding.
...
pub const SUPERSEDED: DictAttribute = DictAttribute {
