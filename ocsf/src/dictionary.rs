...
/// Boundary - The boundary of the connection, normalized to the caption of 'boundary_id'. In the case of 'Other', it is defined by the event source.
...
/// Country - The ISO 3166-1 Alpha-2 country code. For the complete list of country codes see <a target='_blank' href='https://www.iso.org/obp/ui/#iso:pub:PUB500001:en' >ISO 3166-1 alpha-2 codes</a>.
...
/// HTTP Method - The HTTP request method indicates the desired action to be performed for a given resource. Expected values:  
/// * TRACE</li>
/// * CONNECT</li>
/// * OPTIONS</li>
/// * HEAD</li>
...
/// Cleartext Credentials - Indicates whether the credentials were passed in clear text.
...
/// Network Interfaces - The network interfaces that are associated with the device, one for each unique MAC address/IP address/hostname/name combination.
...
///
///
/// * <strong>ads_name</strong></li>
/// * <strong>ads_size</strong></li>
/// * <strong>dacl</strong></li>
/// * <strong>owner</strong></li>
/// * <strong>primary_group</strong></li>
/// * <strong>link_name</strong> - name of the link associated to the file.</li>
/// * <strong>hard_link_count</strong> - the number of links that are associated to the file.</li>
