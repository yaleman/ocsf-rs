...
/// This was the schema version that the code was generated from (1.0.0-rc.3).

pub static OCSF_SCHEMA_VERSION: &str = "1.0.0-rc.3";
...
pub struct Datetime {
    ...
    attributes: std::collections::HashMap<String, crate::EventAttribute>,
}

/// The attributes that identify cloud attributes.
#[derive(Debug, serde::Deserialize, serde::Serialize)]
pub struct Cloud {
    name: String,
    caption: String,
