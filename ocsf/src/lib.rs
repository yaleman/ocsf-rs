...
/// This was the schema version that the code was generated from (1.1.0-dev).

pub static OCSF_SCHEMA_VERSION: &str = "1.1.0-dev";
...
impl From<HttpActivity> for u8 {
    fn from(input: HttpActivity) -> u8 {
        match input {
            HttpActivity::Unknown => 0,
            HttpActivity::Connect => 1,
            HttpActivity::Delete => 2,
            HttpActivity::Get => 3,
            HttpActivity::Head => 4,
            HttpActivity::Options => 5,
            HttpActivity::Post => 6,
            HttpActivity::Put => 7,
            HttpActivity::Trace => 8,
            HttpActivity::Other => 99,
        }
    }
}

impl TryFrom<u8> for HttpActivity {
    type Error = String;

    fn try_from(input: u8) -> Result<Self, String> {
        let res = match input {
            0 => HttpActivity::Unknown,
            1 => HttpActivity::Connect,
            2 => HttpActivity::Delete,
            3 => HttpActivity::Get,
            4 => HttpActivity::Head,
            5 => HttpActivity::Options,
            6 => HttpActivity::Post,
            7 => HttpActivity::Put,
            8 => HttpActivity::Trace,
            99 => HttpActivity::Other,
            _ => return Err("invalid value".to_string()),
        };
        Ok(res)
    }
